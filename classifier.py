...
class Classifier:
    ...
    def Load_Model_Arch(self):
        ...
        print("/n[INFO]Architecture Loaded...")
    ...
    #         "C:/Users/OM/Desktop/obj/pedissatrian detection/Pedestrian-Detection-using-CNN/train-20240519T093552Z-001/train",
    #         target_size=(160, 80), batch_size=32, class_mode='binary')
    #     test_set = test_datagen.flow_from_directory(
    #         "C:/Users/OM/Desktop/obj/pedissatrian detection/Pedestrian-Detection-using-CNN/test-20240519T093552Z-001/test",
    #         target_size=(160, 80), batch_size=32, class_mode='binary')
    #     filepath = "C:/Users/OM/Desktop/obj/pedissatrian detection/Pedestrian-Detection-using-CNN/Trained_model.keras"
    ...
    #     )
    #     end = time.time()
    #     self.classifier.save("Trained_model.keras")
    #     print("/n[INFO]Trained Successfully...")
    #     print('Time to train:', (end - start), " seconds.")

    def load_trained_model(self):
        self.classifier.load_weights('Trained_model.keras')
        print("/n[INFO]Model Loaded Successfully...")
    ...
    def update_frame(self):
        ...
        if bboxes:
            ...
            final_bboxes = non_max_suppression_fast(bboxes, 0.3)
    ...
    #     # self.btn_arch = tk.Button(self.window, text="Load Architecture", width=50, command=self.Load_Model_Arch)
    ...
    #     # self.btn_load = tk.Button(self.window, text="Load Trained Model", width=50, command=self.load_trained_model)
